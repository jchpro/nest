...
program
  ...
  .option('-d, --directory', 'Path to the directory with migration files, relative to source root', 'migrations')
  .option('-f, --default', 'Set this project as default for CLI commands', false)
  .action(setup);
